    ...
    pages: [
      {
        ...
        elements: [
          ...
          { id: createId(), type: 'text', position: { x: 604, y: 114 }, size: { width: 200, height: 20 }, rotation: 0, locked: false, text: '카테고리를 입력하세요', placeholder: '카테고리를 입력하세요', textStyle: { fontSize: 14, fontWeight: 700, color: '#E11D48', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 140 }, size: { width: 1252, height: 30 }, rotation: 0, locked: false, text: '베네핏 + USP를 입력하세요', placeholder: '베네핏 + USP를 입력하세요', textStyle: { fontSize: 20, fontWeight: 700, color: '#111827', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 184 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '기능명을 입력하세요', placeholder: '기능명을 입력하세요', textStyle: { fontSize: 17, fontWeight: 600, color: '#374151', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 210 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '자세한 설명을 적어주세요', placeholder: '자세한 설명을 적어주세요', textStyle: { fontSize: 16, fontWeight: 400, color: '#6B7280', textAlign: 'left', lineHeight: 1.5, fontFamily: 'Noto Sans KR' } },
          ...
          { id: createId(), type: 'text', position: { x: 604, y: 262 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '기능명을 입력하세요', placeholder: '기능명을 입력하세요', textStyle: { fontSize: 17, fontWeight: 600, color: '#374151', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 288 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '자세한 설명을 적어주세요', placeholder: '자세한 설명을 적어주세요', textStyle: { fontSize: 16, fontWeight: 400, color: '#6B7280', textAlign: 'left', lineHeight: 1.5, fontFamily: 'Noto Sans KR' } },
          ...
          { id: createId(), type: 'text', position: { x: 604, y: 415 }, size: { width: 200, height: 20 }, rotation: 0, locked: false, text: '카테고리를 입력하세요', placeholder: '카테고리를 입력하세요', textStyle: { fontSize: 14, fontWeight: 700, color: '#E11D48', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 441 }, size: { width: 1252, height: 30 }, rotation: 0, locked: false, text: '베네핏 + USP를 입력하세요', placeholder: '베네핏 + USP를 입력하세요', textStyle: { fontSize: 20, fontWeight: 700, color: '#111827', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 485 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '기능명을 입력하세요', placeholder: '기능명을 입력하세요', textStyle: { fontSize: 17, fontWeight: 600, color: '#374151', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 511 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '자세한 설명을 적어주세요', placeholder: '자세한 설명을 적어주세요', textStyle: { fontSize: 16, fontWeight: 400, color: '#6B7280', textAlign: 'left', lineHeight: 1.5, fontFamily: 'Noto Sans KR' } },
          ...
          { id: createId(), type: 'text', position: { x: 604, y: 563 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '기능명을 입력하세요', placeholder: '기능명을 입력하세요', textStyle: { fontSize: 17, fontWeight: 600, color: '#374151', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 589 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '자세한 설명을 적어주세요', placeholder: '자세한 설명을 적어주세요', textStyle: { fontSize: 16, fontWeight: 400, color: '#6B7280', textAlign: 'left', lineHeight: 1.5, fontFamily: 'Noto Sans KR' } },
          ...
          { id: createId(), type: 'text', position: { x: 604, y: 716 }, size: { width: 200, height: 20 }, rotation: 0, locked: false, text: '카테고리를 입력하세요', placeholder: '카테고리를 입력하세요', textStyle: { fontSize: 14, fontWeight: 700, color: '#E11D48', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 742 }, size: { width: 1252, height: 30 }, rotation: 0, locked: false, text: '베네핏 + USP를 입력하세요', placeholder: '베네핏 + USP를 입력하세요', textStyle: { fontSize: 20, fontWeight: 700, color: '#111827', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 786 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '기능명을 입력하세요', placeholder: '기능명을 입력하세요', textStyle: { fontSize: 17, fontWeight: 600, color: '#374151', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 812 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '자세한 설명을 적어주세요', placeholder: '자세한 설명을 적어주세요', textStyle: { fontSize: 16, fontWeight: 400, color: '#6B7280', textAlign: 'left', lineHeight: 1.5, fontFamily: 'Noto Sans KR' } },
          ...
          { id: createId(), type: 'text', position: { x: 604, y: 864 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '기능명을 입력하세요', placeholder: '기능명을 입력하세요', textStyle: { fontSize: 17, fontWeight: 600, color: '#374151', textAlign: 'left', lineHeight: 1.4, fontFamily: 'Noto Sans KR' } },
          { id: createId(), type: 'text', position: { x: 604, y: 890 }, size: { width: 1252, height: 24 }, rotation: 0, locked: false, text: '자세한 설명을 적어주세요', placeholder: '자세한 설명을 적어주세요', textStyle: { fontSize: 16, fontWeight: 400, color: '#6B7280', textAlign: 'left', lineHeight: 1.5, fontFamily: 'Noto Sans KR' } },
